...
%data = load('pizzo/A1_data.txt','-ascii'); 

files = ["emech/lab6/pizzo/trial_1.xlsx", "emech/lab6/pizzo/trial_2.xlsx", "emech/lab6/pizzo/trial_3.xlsx", "emech/lab6/pizzo/trial_4.xlsx", "emech/lab6/pizzo/trial.xlsx"];
    for i=1:length(files)
    data = xlsread(files(1));
